...
//Delivery list
$route['admin/listdelivery'] = "admin/delivery/listdelivery";
$route['deliveryboy/sendOrderForm'] = 'DeliveryBoy/sendOrderForm';
$route['deliveryboy/sendOrder'] = 'DeliveryBoy/sendOrder';
$route['delivery/send_message'] = 'delivery/send_message';
$route['delivery/send_message_form'] = 'delivery/send_message_form';



//DeliveryBoy
$route['delivery-boy'] = 'DeliveryBoy/index';
$route['DeliveryBoy/home'] = 'DeliveryBoy/home';
$route['DeliveryBoy/Orders'] = 'DeliveryBoy/Orders';
$route['DeliveryBoy/order_details/(:any)'] = 'DeliveryBoy/order_details/$1';
