...
<html lang="<?= MY_LANGUAGE_ABBR ?>">
    ...
    <body>
        <a style="display:none !important;" id="kk-refer-gh" href="https://github.com/">Group 6</a>
        <div id="wrapper">
        ...
        <?php if ($multiVendor == 1) { ?>
            <div id="top-user-panel">
                <div class="user-panel">
                    ...
                    <?php } else { ?>
                        <a href="<?= LANG_URL . '/login' ?>" class="my-acc-login button">
                            <?= lang('login') ?>
                        </a>
                        <a href="<?= LANG_URL . '/register' ?>" class="my-acc-register button">
                            <?= lang('register') ?>
                        </a>
                    <?php } ?>
