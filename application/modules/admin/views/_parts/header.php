                        ...
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li><a href="<?= base_url('admin/listdelivery') ?>" <?= urldecode(uri_string()) == 'admin/listdelivery' ? 'class="active"' : '' ?>><i class="fa fa-user" aria-hidden="true"></i> <?= lang('list_delivery') ?></a></li>
                                </ul>
                            </div>
